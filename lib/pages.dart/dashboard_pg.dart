...
import 'package:inventory_software/pages.dart/product_pg.dart';
      ...
      child: const Column(
        ...
        children: [
          Row(
            ...
            children: [
            Text("Current Sales",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 26),),
            Text("View All,")
          ],),
          ListTile(
